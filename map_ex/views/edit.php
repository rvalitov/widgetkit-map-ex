...
?>
<div class="uk-grid uk-grid-divider uk-form uk-form-horizontal uk-mapex" data-uk-grid-margin>
        ...
        <ul id="nav-content-map" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-width">{{'Width (px)' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The width of the widget in pixels or \'auto\'.' | trans}}"><i></i></span></span>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-height">{{'Height (px)' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The height of the widget in pixels.' |trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-maptypeid">{{'Map Type' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The map type used in the widget. The \'Styled\' type is a map that is customized in the \'Styles\' settings section. Other types are the classic Google Map\'s types.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-map_center">{{'Map Center Point' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The map will be displayed in a way that this point will be located right in the center of the map. The center point is defined by its coordinates, e.g. -34.23456, 12.15672.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-zoom">{{'Phone Portrait' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Initial zoom level of the map. The higher numbers - the greater the zoom is (more detailed map). The value 0 corresponds to a map of the Earth fully zoomed out.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-zoom_phone_h">{{'Phone Landscape' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Initial zoom level of the map. The higher numbers - the greater the zoom is (more detailed map). The value 0 corresponds to a map of the Earth fully zoomed out.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-zoom_tablet">{{'Tablet' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Initial zoom level of the map. The higher numbers - the greater the zoom is (more detailed map). The value 0 corresponds to a map of the Earth fully zoomed out.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-zoom_desktop">{{'Desktop' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Initial zoom level of the map. The higher numbers - the greater the zoom is (more detailed map). The value 0 corresponds to a map of the Earth fully zoomed out.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-zoom_large">{{'Large Screens' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Initial zoom level of the map. The higher numbers - the greater the zoom is (more detailed map). The value 0 corresponds to a map of the Earth fully zoomed out.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Disable default UI' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'If checked, then the Google Map API\'s default UI settings are disabled entirely. This option is \'off\' by default.' |trans}}"><i></i></span></span>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Type Controls' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Enables/disables the Map Type control that lets the user toggle between map types (such as Map and Satellite).'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row" ng-if="widget.data.maptypecontrol == '1'">
                    <span class="uk-form-label">{{'Available types' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The list of map types that will show in the map\'s type controls. Google displays maximum first 3 map types.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Zoom Controls' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Show zoom controls: \'+\' and \'-\' buttons for zooming.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row" ng-if="widget.data['zoomcontrol'] == '1'">
                    <span class="uk-form-label" for="wk-zoom_style">{{'Zoom Style' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="The style of the zoom control. The 'Default' style means that Google Map will choose the style according to its internal logic."><i></i></span></span>
                    <div class="uk-form-controls">
				...
				*/
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Street View Controls' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Enables/disables the Pegman control that lets the user activate a Street View panorama.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Scale Controls' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Enables/disables the Scale control that provides a simple map scale.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				*/
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Directions Controls' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Enables/disables the directions button that opens the Google Map in a new window for navigation and routing.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row" ng-if="widget.data.directions == '1'">
                    <span class="uk-form-label">{{'Directions Label' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Text to show on the directions button. If left empty, then the default value is used: \'Get directions\'.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Scroll Wheel' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'If checked, then user can zoom in and out using the mouse wheel.' |trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Draggable' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'If checked, then user can move the map. If unchecked, then the map\'s location is fixed (static) and can\'t be changed by the user.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-marker">{{'Marker' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Select if you want to display markers or not. If yes, then you can choose the popup window\'s behaviour.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
						...
						<p class="uk-form-controls-condensed" ng-if="widget.data.marker == '2'">
                            <span><input class="uk-form-width-mini" type="checkbox" ng-model="widget.data['autohide']"> {{'Single popup' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'This option controls the maximum number of popup windows that can be visible at once. If checked, then maximum one popup is visible at a time and other popups will automatically hide. If unchecked, then any number of popups can be visible without restrictions.'|trans}}"><i></i></span></span>
                        </p>
                    </div>
                </div>

				<div class="uk-form-row" ng-if="widget.data['marker'] > 0">
                    <span class="uk-form-label" for="wk-pin_type">{{'Marker Pin Icon' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Select a type of pin that will be used in map markers.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['pin_type'] == ''">
					<span class="uk-form-label">{{'Anchor' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'The anchor is a place where the icon\'s hotspot is located. The position is defined in pixels and is relative to the the image\'s dimensions, so that the bottom left corner of the image is a zero-point (0,0); axes have standard orientation: the X to the right; Y to the top. If the position is empty then the bottom center of the image is set as the anchor.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
            ...
            <li>
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Name' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The label that will be displayed in the type controls to refer to your custom map style. If left empty, then the default value \'Styled\' is used'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Styling Mode' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'There are 2 modes: \'Simple\' is the default that allows you to do some basic styling. For for arbitrary styling choose \'Advanced\' mode.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['styling_mode'] == 'json'">
					<span class="uk-form-label">{{'Custom Style (JSON)' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Enter the text for you custom style. The data must be in JSON format and comply with Google Maps API rules. You may use the Google\'s Styled Map Wizard tool below to easily create the desired styling.'|trans}}"><i></i></span></span>
					<div class="uk-form-controls">
				...
				<div class="uk-form-row uk-text-center" ng-if="widget.data['styling_mode'] == 'json'">
					<a href="https://mapstyle.withgoogle.com/" class="uk-button uk-button-primary uk-container-center" target="_blank">{{'Launch the Styled Maps Wizard'|trans}}<i class="uk-icon uk-icon-external-link uk-margin-small-left"></i></a>
				</div>
				
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label">{{'Invert' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Simply inverts the existing lightness. This is useful, for example, for quickly switching to a darker map with white text.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label" for="wk-styler-hue">{{'Hue' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Enter an RGB hex string that indicates the basic color. The default value is #ff0000.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label" for="wk-styler-saturation">{{'Saturation' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Saturation is a floating point value between -100 and 100 that indicates the percentage change in intensity of the basic color to apply to the element.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label" for="wk-styler-lightness">{{'Lightness' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Lightness is a floating point value between -100 and 100 that indicates the percentage change in brightness of the element. Negative values increase darkness (where -100 specifies black) while positive values increase brightness (where +100 specifies white).'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label" for="wk-styler-gamma">{{'Gamma' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Gamma is a floating point value between 0.01 and 10.0 (where 1.0 applies no correction) indicates the amount of gamma correction to apply to the element. Gammas modify the lightness of hues in a non-linear fashion, while not impacting white or black values. Gammas are typically used to modify the contrast of multiple elements. For example, you could modify the gamma to increase or decrease the contrast between the edges and interiors of elements. Low gamma values (less than 1) increase contrast, while high values (greater than 1) decrease contrast.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-tiles_color">{{'Tiles Background' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Color used for the background of the Map. This color will be visible when tiles have not yet loaded as the user pans. Example: #ff0000. The default value is empty that uses the default color of Google Maps (currently it is light grey).'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Display' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Display the image inside the popup.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Image' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Set the width and height of the image in pixels. Use \'auto\' for auto size.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-media-align">{{'Alignment' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Define the image alignment regarding to the content in the popup.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_align == 'left' || widget.data.media_align == 'right'">
                            <label>
                                ...
                                {{'Column Width' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Defines the size of the column for the image. Another width that is left will be used to display the content.'|trans}}"><i></i></span>
                            </label>
                        </p>
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_align == 'left' || widget.data.media_align == 'right'">
                            <label>
                                ...
                                {{'Breakpoint' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Defines screen size when the columns will stack.'|trans}}"><i></i></span>
                            </label>
                        </p>
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-media-border">{{'Border' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Defines the style of the image\'s border inside the Popup.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-media-overlay">{{'Overlay' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Define what will be displayed inside the overlay or hide the overlay.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_overlay == 'icon' || widget.data.media_overlay == 'social-buttons'">
                            <label>
                                ...
                                {{'Animation' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'The animation that will be applied to the overlay when being displayed on hover.'|trans}}"><i></i></span>
                            </label>
                        </p>
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-thumbnail-animation">{{'Image Animation' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'The animation that will be applied to the image on hover.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
			...
			<li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-cluster_type">{{'Clustering Mode' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Defines how clustering will work. If enabled, there are 2 modes: \'Simple\' mode mimics the standard behaviour of standard Map widget; \'Advanced\' - is a superior mode that gives a full control of the clustering.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['markercluster']=='custom'">
					<span class="uk-form-label" for="wk-cluster_gridSize">{{'Grid Size' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The grid size of a cluster in pixels. The higher values join the markers into clusters more condensed, therefore resulting in a lower number of total clusters. The default value is 60.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['markercluster']=='custom'">
                    <span class="uk-form-label" for="wk-cluster_maxZoom">{{'Max Zoom Level' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The maximum zoom level that a marker can be part of a cluster.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['markercluster']=='custom'">
                    <span class="uk-form-label" for="wk-cluster_minimumClusterSize">{{'Minimum Markers' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The minimum number of markers to be in a cluster before the markers are hidden and a count is shown.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<ul id="mapex-clusters" class="uk-switcher uk-margin" ng-if="widget.data['markercluster']=='custom'">
					<li>
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Icon' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Path to an image file that will be used as a cluster\'s icon. PNG and SVG image formats are recommended.'|trans}}"><i></i></span></span>
							<div class="uk-form-controls">
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Icon Anchor' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The anchor is a place where the icon\'s hotspot is located. The position is defined in pixels and is relative to the the image\'s dimensions, so that the upper left corner of the image is a zero-point (0,0); axes have the following orientation: the X to the right; Y to the bottom. If any of the values is empty then the center of the image is set as the anchor.'|trans}}"><i></i></span></span>
							<div class="uk-form-controls">
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Text Size' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'The size of text label of the cluster marker in pixels. The default value is 11.'|trans}}"><i></i></span></span>
							<div class="uk-form-controls">
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Text Color' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Color of text of the cluster marker. Example: #ff0000. Standard HTML color names are also valid. The default value is black.'|trans}}"><i></i></span></span>
							<div class="uk-form-controls">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Display' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Show or hide title, content and social buttons.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                        <p class="uk-form-controls-condensed">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-title-size">{{'Title Size' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Define the font size of the title.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-text-align">{{'Alignment' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Define the text alignment.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Display' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Display the Read More link. The link URL is added to each item in the Content Manager.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-link-style">{{'Style' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Set the style of the Read More link.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-link-text">{{'Text' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Define the link text.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Link Target' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Enables/disables opening all links in a new window of the browser. Otherwise, they open in the same window.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-class">{{'HTML Class' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'Adds a custom CSS class to the widget. You can specify several classes using space between them.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Debug output' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{'If checked, then the MapEx will print some debug and status information to the browser\'s console window. This option should be off by default and is intended to be used for investigating problems with the widget.'|trans}}"><i></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
			...
			<li>
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-width">{{'API key' | trans}}<span data-uk-tooltip="'cls':'uk-mapex-tooltip'" title="{{ 'Google API key that you should obtain from Google in order to use the Google Map services.' | trans}}"><i></i></span></span>
                    <div class="uk-form-controls">
						<?php if ($is_api_key_supported): ?>
