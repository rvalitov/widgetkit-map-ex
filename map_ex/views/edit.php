        ...
        <ul id="nav-content-map" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-width">{{'Width (px)' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'The width of the widget in pixels or \'auto\'.' | trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-height">{{'Height (px)' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'The height of the widget in pixels.' |trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label" for="wk-map_center">{{'Map Center Point' | trans}}<span data-uk-tooltip title="{{ 'The map will be displayed in a way that this point will be located right in the center of the map. The center point is defined by its coordinates, e.g. -34.23456, 12.15672.' | trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Disable default UI' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'If checked, then the Google Map API\'s default UI settings are disabled entirely. This option is \'off\' by default.' |trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Type Controls' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Enables/disables the Map Type control that lets the user toggle between map types (such as Map and Satellite).'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row" ng-if="widget.data.maptypecontrol == '1'">
                    <span class="uk-form-label">{{'Available types' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'The list of map types that will show in the map\'s type controls. Google displays maximum first 3 map types.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Zoom Controls' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Show zoom controls: \'+\' and \'-\' buttons for zooming.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				*/
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Street View Controls' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Enables/disables the Pegman control that lets the user activate a Street View panorama.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Scale Controls' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Enables/disables the Scale control that provides a simple map scale.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				*/
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Directions Controls' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Enables/disables the directions button that opens the Google Map in a new window for navigation and routing.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-form-row" ng-if="widget.data.directions == '1'">
                    <span class="uk-form-label">{{'Directions Label' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Text to show on the directions button. If left empty, then the default value is used: \'Get directions\'.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Scroll Wheel' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'If checked, then user can zoom in and out using the mouse wheel.' |trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-marker">{{'Marker' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Select if you want to display markers or not. If yes, then you can choose the popup window\'s behaviour.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['marker'] > 0">
                    <span class="uk-form-label" for="wk-pin_type">{{'Marker Pin Icon' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Select a type of pin that will be used in map markers.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['pin_type'] == ''">
                    <span class="uk-form-label">{{'Image' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Path to an image file that will be used as a custom pin icon. PNG and SVG image formats are recommended. This setting sets the default icon for all map markers (elements). If this field is left empty, then a default icon will be used. You can set a unique icon for any map marker: you can do this by setting a \'Custom Pin Image\' field in the \'Content Settings\' tab. This field is visible and available only if you use \'Custom\' content source type. The \'Custom Pin Image\' field has a higher priority and if set will override the value of this setting.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
            ...
            <li>
				...
				<div class="uk-form-row">
                    <span class="uk-form-label">{{'Styling Mode' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'There are 2 modes: \'Simple\' is the default that allows you to do some basic styling. For for arbitrary styling choose \'Advanced\' mode.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['styling_mode'] == 'json'">
					<span class="uk-form-label">{{'Custom Style (JSON)' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Enter the text for you custom style. The data must be in JSON format and comply with Google Maps API rules. You may use the Google\'s Styled Map Wizard tool below to easily create the desired styling.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
					<div class="uk-form-controls">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label">{{'Invert' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Simply inverts the existing lightness. This is useful, for example, for quickly switching to a darker map with white text.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label" for="wk-styler-hue">{{'Hue' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Enter an RGB hex string that indicates the basic color. The default value is #ff0000.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row" ng-if="widget.data['styling_mode'] == ''">
                    <span class="uk-form-label" for="wk-styler-lightness">{{'Lightness' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Lightness is a floating point value between -100 and 100 that indicates the percentage change in brightness of the element. Negative values increase darkness (where -100 specifies black) while positive values increase brightness (where +100 specifies white).'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Display' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Display the image inside the popup.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-media-align">{{'Alignment' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Define the image alignment regarding to the content in the popup.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_align == 'left' || widget.data.media_align == 'right'">
                            <label>
                                ...
                                {{'Column Width' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Defines the size of the column for the image. Another width that is left will be used to display the content.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span>
                            </label>
                        </p>
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_align == 'left' || widget.data.media_align == 'right'">
                            <label>
                                ...
                                {{'Breakpoint' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Defines screen size when the columns will stack.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span>
                            </label>
                        </p>
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-media-border">{{'Border' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Defines the style of the image\'s border inside the Popup.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
			...
			<li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label" for="wk-cluster_type">{{'Clustering Mode' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Defines how clustering will work. If enabled, there are 2 modes: \'Simple\' mode mimics the standard behaviour of standard Map widget; \'Advanced\' - is a superior mode that gives a full control of the clustering.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['markercluster']=='custom'">
					<span class="uk-form-label" for="wk-cluster_gridSize">{{'Grid Size' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'The grid size of a cluster in pixels. The higher values join the markers into clusters more condensed, therefore resulting in a lower number of total clusters. The default value is 60.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<div class="uk-form-row" ng-if="widget.data['markercluster']=='custom'">
                    <span class="uk-form-label" for="wk-cluster_maxZoom">{{'Max Zoom Level' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'The maximum zoom level that a marker can be part of a cluster.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
                    <div class="uk-form-controls">
				...
				<ul id="mapex-clusters" class="uk-switcher uk-margin" ng-if="widget.data['markercluster']=='custom'">
					<li>
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Icon' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'Path to an image file that will be used as a cluster\'s icon. PNG and SVG image formats are recommended.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
							<div class="uk-form-controls">
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Text Size' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{ 'The size of text label of the cluster marker in pixels. The default value is 11.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
							<div class="uk-form-controls">
						...
						<div class="uk-form-row">
							<span class="uk-form-label">{{'Text Color' | trans}}<span  data-uk-tooltip style="margin-top: 5px;" title="{{'Color of text of the cluster marker. Example: #ff0000. Standard HTML color names are also valid. The default value is black.'|trans}}"><i class="uk-icon uk-icon-question-circle uk-margin-small-left" style="color:#ffb105"></i></span></span>
							<div class="uk-form-controls">
